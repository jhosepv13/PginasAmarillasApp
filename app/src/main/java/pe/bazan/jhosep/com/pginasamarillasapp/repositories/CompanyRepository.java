...
public class CompanyRepository {
    ...
    static {
        companies.add(new Company(100, "Restaurant", "Alameda", "Jr. de la Unión", "0176376213",
                "alameda@gmail.com", "alamaeda.oom.pe","ic_company1", "Disfruta de nuestras mejores promociones y exquisitos platillos."));

        companies.add(new Company(200, "SuperMarket", "Metro", "San Juan de Lurigancho", "016542146",
                "metro@gmail.com", "www.metro.oom.pe","ic_company2", "Ofrecemos variedad de productos para cualquier tipo de cliente."));
       ...
       companies.add(new Company(400, "Bank", "BBVA", "Centro de Lima", "017462164",
        ...
        companies.add(new Company(1000, "Pizza", "Pizza Hut", "Ov. Santa Anita", "0177610321",
                "PizzaHut@gmail.com", "https://www.pizzahut.com.pe/Online/Home/Home","ic_company0", "Ven y prueba nuestras mejores pizzas para toda la familia."));
        ...
        companies.add(new Company(1000, "Pizza", "Pizza Hut", "Ov. Santa Anita", "0177610321",
                "PizzaHut@gmail.com", "pizzahut.oom.pe","ic_company0", "Ven y prueba nuestras mejores pizzas para toda la familia."));
